...
- **Deleting an item.** The build-plan line is "create, edit and list". A delete
  would also orphan the `itemId` references that features 3 and 4 depend on, so
  it needs its own decision about what happens to historical purchases.
...
- [ ] **3. Items cubit with sealed states**
...
- [ ] **4. Catalogue list screen, reachable from Home**
...
- [ ] **5. Item form, creating a new item**
